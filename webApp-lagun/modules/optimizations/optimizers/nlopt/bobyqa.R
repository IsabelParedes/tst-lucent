...
# BOBYQA : Local Derivative Free optimizer with bound constraints

bobyqa.run <- function(PbDefinition, ParametersValues, AdvancedParametersValues) {
  library(nloptr)
  
  opts <- append(append(list("algorithm"= "NLOPT_LN_BOBYQA"),ParametersValues), AdvancedParametersValues)
...
bobyqa.description <- function(){

	DisplayName="NLOPT BOBYQA"

	Description="BOBYQA performs local derivative-free bound-constrained optimization using an iteratively constructed quadratic approximation for the objective function."
