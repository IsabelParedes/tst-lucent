...
local({
  ...
  renv_bootstrap_repos <- function() {
    ...
    # get CRAN repository
    cran <- getOption("renv.repos.cran", "http://cloud.r-project.org")
    ...
    default <- c(FALLBACK = "http://cloud.r-project.org")
  ...
  renv_bootstrap_download_impl <- function(url, destfile) {
    ...
    # http://bugs.r-project.org/bugzilla/show_bug.cgi?id=17715
    fixup <-
  ...
  renv_bootstrap_download_github <- function(version) {
    ...
    url <- file.path("http://api.github.com/repos/rstudio/renv/tarball", version)
    name <- sprintf("renv_%s.tar.gz", version)
    destfile <- file.path(tempdir(), name)
  ...
  # (see http://www.kernel.org/pub/software/scm/git/docs/git-archive.html)
  ...
  renv_bootstrap_platform_prefix_auto <- function() {
    ...
    if (inherits(prefix, "error") || prefix %in% "unknown") {
      ...
      msg <- paste(
        ...
        "please file a bug report at http://github.com/rstudio/renv/issues",
        sep = "; "
      )
  ...
  renv_bootstrap_validate_version <- function(version, description = NULL) {
    ...
    # http://github.com/rstudio/renv/issues/1625
